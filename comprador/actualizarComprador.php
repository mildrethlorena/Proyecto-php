...
<header>
    ...
    try{
        ...
        while($consulta=$resultado->fetch(PDO::FETCH_ASSOC)){
            ?>
    <div class="signupFrm" style="margin-top: -100px;">
    <form action="actualizarComprador2.php?cod=<?php echo $consulta['pk_identificacion'] ?>" class="form" method="post">
      <h1 class="title">Actualización de datos</h1>

      <div class="inputContainer">
        <input type="text" class="input" placeholder="a" name="txtn" value="<?php echo $consulta['nombre_user'];?>" required>
