...
<body>
    ...
    while($consulta=$resultado->fetch(PDO::FETCH_ASSOC)){
        ...
        <tr>
            <td style="text-align:center"><a href="eliminar2Ar.php?cod2=<?php echo $consulta['pk_codigo_pdto'];?>." class="btn btn-success">Si</a></td>
            <td style="text-align:center"><a href="productosArtesano.php" class="btn btn-danger">No</a></td>
        </tr>
        <?php
    }
    ?>
