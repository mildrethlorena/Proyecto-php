...
<body>
 <?php include 'menu.php' ?>
    ...
    <div class="container">
    <a href="insertarProductoArtesano.php" class="btn btn-success">Nuevo</a></div><br>
        ...
        function FiltrarCatalogo(){
            ...
            .then(res => {
                ...
                res.forEach(element => {
                    ...
                    <td><a href="eliminar1Ar.php?cod=${element.pk_codigo_pdto}" class="btn btn-danger">Eliminar</a></td>
                    <td><a href="actualizarAr1.php?cod2=${element.pk_codigo_pdto}" class="btn btn-success">Actualizar</a></td>
                    </tr>`
                    //console.log(element);
                });
